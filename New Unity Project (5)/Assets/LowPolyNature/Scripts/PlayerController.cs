...
public class PlayerController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        mHealthBar = Hud.transform.Find("Bars_Panel_Left/HealthBar").GetComponent<HealthBar>();
        mHealthBar.Min = 0;
        mHealthBar.Max = Health;
        startHealth = Health;

        mFoodBar = Hud.transform.Find("Bars_Panel_Left/FoodBar").GetComponent<HealthBar>();
        mFoodBar.Min = 0;
        mFoodBar.Max = Food;
        startFood = Food;
